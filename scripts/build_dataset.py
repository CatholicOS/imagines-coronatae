...
doc={'metadata':{
 ...
 'caveats':[
   ...
   'The archives of the Chapter of St Peter’s Basilica are not published online and were NOT consulted. '
   'They remain the principal unexamined source for coronations before 1909 and for many after it.',
